...
<head>
    ...
    <style>
        body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 30px; background: #fdf2f4; color: #333; line-height: 1.6; }
        .container { max-width: 1000px; margin: auto; background: white; padding: 30px; border-radius: 12px; box-shadow: 0 5px 15px rgba(0,0,0,0.08); }
        ...
        .avatar-img { 
            ...
            border: 3px solid #cca3bb; object-fit: cover; margin-right: 20px; 
        }
        .welcome-text h1 { margin: 0; font-size: 28px; color: #333; }
        
        .nav-links a { 
            text-decoration: none; color: #b089a0; font-weight: bold; 
            margin-left: 15px; transition: 0.3s; 
        }
        .nav-links a:hover { color: #d147a3; }
        ...
        .box { 
            padding: 20px; border-radius: 10px; border: 1px solid rgba(0,0,0,0.05); 
            transition: transform 0.2s; 
        }
        .box:hover { transform: translateY(-3px); }
        .box h3 { margin-top: 0; color: #444; border-bottom: 1px solid rgba(0,0,0,0.1); padding-bottom: 8px; }

        .customer-box { background: #fff; border: 1px solid #f2dae5; }
        .waiter-box { background: #f9f0ff; border-left: 5px solid #d1b3ff; }
        .kitchen-box { background: #fef9fa; border-left: 5px solid #cca3bb; }
        .manager-box { background: #fff5f6; border-left: 5px solid #f2c7ce; }
        ...
        .box a:hover { background: #cca3bb; color: white; }
    ...
    <header class="header-section">
        <div class="user-info">
            ...
            <div class="welcome-text">
                <h1>Bistro FDI</h1>
                <span>Welcome, <strong><?= htmlspecialchars($username) ?></strong> <small>(<?= ucfirst($role) ?>)</small></span>
            </div>
        </div>
        <div class="nav-links">
